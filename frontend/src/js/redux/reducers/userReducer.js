...
const userArticleEditInit = (state, action) => {
    return updateObject(state, {
        loading: true,
        userProfile: null,
        error: null
...
const userArticleEditSuccess = (state, action) => {
    return updateObject(state, {
        loading: false,
        userProfile: null,
        error: null
...
const userArticleEditFail = (state, action) => {
    return updateObject(state, {
        loading: false,
        userProfile: null,
        error: action.error
...
const reducer = (state = initialState, action) => {
    switch (action.type) {
        ...
        case actionTypes.USER_ARTICLE_EDIT_INIT:
            return userArticleEditInit(state, action);
        case actionTypes.USER_ARTICLE_EDIT_SUCCESS:
            return userArticleEditSuccess(state, action);
        case actionTypes.USER_ARTICLE_EDIT_FAIL:
            return userArticleEditFail(state, action);
        default:
            return state;
    }
};
